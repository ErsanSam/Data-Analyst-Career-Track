...
df['product_id'] = df['product_value'].apply(lambda x: inpute_product_fal(x))
...
df["order_date"] = pd.to_datetime(df["order_date"].apply(lambda x:
                                                         str(x)[-4:] + "-" + months_dict[str(x)[:3]] + "-" + str(x)[4:6]))
print(" Tipe data:\n", df.dtypes)
...
print("Dataset akhir:\n", df_jan2019)
#df_jan2019.to_excel("df_jan2019.xlsx")
# END OF PROJECT