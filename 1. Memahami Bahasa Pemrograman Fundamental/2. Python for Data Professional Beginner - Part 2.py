#Collection manipulation with python
#mengakses list dan tupple part 1
...
score_pertama_budi = tuple_score.index('Budi')
print(score_pertama_sud) # akan menampilkan output 2
print(score_pertama_budi) #budi akan tetap 0
#tuple
# Fitur .add()
print(">>> Fitur .add()")
...
komentar_terbaik ='''Sepatunya Nyaman ,
dipakai bahannya halus'''
print(komentar_terbaik)
...
def fungsi_dengan_argumen(nama_depan, nama_belakang = ""):
	print(nama_depan+" "+nama_belakang)
# Panggil fungsi dengan memasukkan argumen nama_depan "Ersan"
fungsi_dengan_argumen("Ersan")
# Panggil fungsi dengan memasukkan argumen
# nama_depan yaitu "Ersan" dan nama_belakang "Fernando"
fungsi_dengan_argumen("Ersan", "Fernando")
...
file1.write("Sekarang kita belajar menulis dengan menggunakan Python")
file1.write("Menulis konten file dengan mode w (write).")
file1.close()

# Menulis ke file dengan mode append
file2 = open("hello3.txt", "a")
file2.writelines([
...
#MINI PROJECT Harga Rumah di Tangerang
# STEP 1:
